...
class BamlStreamClient:
    ...
    def ExtractAssertion(
        ...
        idea: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Assertion, types.Assertion]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.Assertion, types.Assertion](
        raw,
    ...
    def ExtractIdea(
        ...
        idea: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.Idea, types.Idea]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.Idea, types.Idea](
        raw,
